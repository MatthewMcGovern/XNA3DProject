...
namespace Isomites.IsoEngine.World
{
    ...
    public class ImSegmentLocation
    {
        ...
        public ImSegmentLocation(Vector3 worldLocation)
        {
            ...
            RenderSegmentIndex = (int)Math.Floor((double)(worldLocation.Y / ImGlobal.RenderSegmentSize.Y));
            RenderSegmentBlockMaskIndex = (int)worldLocation.Y%ImGlobal.RenderSegmentSize.Y;
        }
